function o = call_cells_inputmean(o, ClassMeanExpression, BackgroundImage, CellMap)
% o = o.call_cells(gSet)
%  
...
MeanClassExp = o.Inefficiency * MeanClassExp;
...
try
    ...
    save(o.CellMapFile, 'ScaledExp', 'eGeneGamma', 'IncludeSpot', 'RelCellRadius');
end
